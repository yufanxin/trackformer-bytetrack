...
ex.add_named_config('VisDrone', 'cfgs/train_VisDrone.yaml') #Eited
...
def train(args: Namespace) -> None:
    ...
    if args.tracking:
        ...
        if args.tracking_eval:
            assert 'mot' in args.dataset or 'VisDrone' in args.dataset # Edited
    ...
    for epoch in range(args.start_epoch, args.epochs + 1):
        ...
        if not epoch % args.val_interval: # Edited
        # if False:
